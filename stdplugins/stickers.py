...
async def _(event):
    ...
    me = borg.me
    userid = borg.uid
    username = borg.me.first_name
    packname = f"{username}'s @UniBorg Pack"
    packshortname = f"KP1_of_{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"{username}'s @AnimatedStickersGroup"
        packshortname = f"KP1_of_{userid}_as"  # format: Uni_Borg_userid
