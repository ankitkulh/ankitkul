...
@borg.on(admin_cmd(pattern="autopic ?(.*)", allow_sudo=True))
async def autopic(event):
    hmm = await edit_or_reply(event, event.from_id, "Initiating Autopic... ")
    ...
    while True:
        ...
        #drawn_text.text((20,20), "@PhycoNinja13b", font=cfnt, fill=(220,220,220))
        img.save(photo)
